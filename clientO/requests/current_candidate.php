<?php
    ...
    if ($t1 == $t2) {
        if (isset($_GET["id"])) {
            ...
            $sql = "SELECT firstname, university, course, college, course_end, `availability`, `type`, school, qualification, grade, ind1, ind2, ind3, descr "
            ...
            $res .=        "<div class=\"viewcircle uni-avatar-" . $uni_temp . "\">"
                 .         "</div>"
                 .     "</div>"
                 #     Candidate overview
                 ...
                 .         "</p>"
                           # Basic actions
                 .         "<button data-toggle=\"modal\" data-target=\"#individual_email\" data-backdrop=\"static\" class=\"sendemail-small\" id=\"myBtn2\">Email</button>"
                 .         "<button class=\"sendemail-small"; 
            ...
            $res .="<div class=\"viewobjectbottom\">"
                 .     "<div class=\"objectleft\">"
                 .         "<p class=\"viewskillstop\">Email:</p>"
                 .         "<p class=\"viewskillstop\">Phone no. </p>"
                 .     "</div>"
                 .     "<div class=\"objectright\">"
                 .         "<p class=\"viewinterestlisttop\">";
            if (!$on_con) {
                ...
                $res .=             $str . $mid . $end
                     .         "</p>"
                     .         "<p class=\"viewinterestlisttop\">07********</p>"
                ...
                $res .= $contact_details["email"] . "</p>"
                     .  "<p class=\"viewinterestlisttop\">" . $mob . "</p>";
            }
            $res .=    "</div>"
                 . "</div>";
            # Form tab buttons
            ...
            $skill_set = sort(json_decode($selected_candidate_details["ind3"]));
            $s = sizeof($skill_set);
            ...
            if ($skill_set != "None provided") {
                $res.= "<h4>Skills</h4>"
                 .     "<div class=\"vdskills\">"
                 .         "<div class=\"inline\">";
                for ($i = 0; $i < $s; $i++) {
                    $res .= "<p class=\"badge badge-secondary\">" . ucfirst($skill_set[$i]) . "</p>";
                }
                $res .=    "</div>"
                 .     "</div>"
            ...
            $res .="<div id=\"cv_tab\" class=\"tabcontent2\" style=\"display:none\">"
                 .     "<embed class=\"cv_box\" src=\"components/cv_viewer.php?user=" . $selected_candidate_id . "\"/>"
                 . "</div>";
            echo $res;
        } 
    }
