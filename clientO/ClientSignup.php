...
if (isset($_POST['createaccount'])) {
        ...
        $email = $_POST['email'];
                ...
                if (password_verify($password, DB::query('SELECT password FROM users WHERE email =:email', array(':email'=>$email))[0]['password'])) {
                        ...
                        DB::query('INSERT INTO posts VALUES (\'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\', \'\',\'\', \'\', :userid, NOW(),\'\')', array(':userid'=>$user_id));
                                                                        echo 'seer!';
...
<head>
    ...
    <title>Client Sign up - Oxford Careers</title>
    ...
    <div class="login-clean">
        <form method="post" onSubmit="check_form(event)">
            ...
            <div class="form-group"><input class="form-control" type="text" name="username" placeholder="Full Name" style="margin-top: 15px;" required>
            						<input class="form-control" type="email" name="email" id="email" placeholder="Oxford email address" style="margin-top: 15px;" required></div>
        ...
        <label style="font-size:12px;"class="form-check-label" for="formCheck-1">By clicking Sign Up, you agree to our <a target="_blank" href="TermsofUse.pdf">Terms of Use</a> and <a target="_blank" href="Privacypolicy.pdf">Privacy Policy</a> and allow the use of Cookies.</label>

            <div class="form-group"><input class="btn btn-primary btn-block" type="submit" value="Sign Up" name="createaccount" style="background-color: #301777;"></div><a href="ClientLogin.php" class="forgot">Already have an account? Login</a></form>
    </div>
