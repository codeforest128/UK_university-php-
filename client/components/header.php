...
<head>
    ...
    <title>VCH Clientside | <?php echo $page_title; ?></title>
	...
	<?php } else if ($page_title == "Database") { ?>
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css">
    ...
    <link href="https://fonts.googleapis.com/css?family=Comfortaa|Heebo&display=swap" rel="stylesheet"> -->
